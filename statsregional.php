...
<br><br><br><br><br><br>
    ...
    <div class="container-fluid">
      ...
      <h3 style="font-size: 30px"> Product: <span style="color: #2E8DCC;font-weight: bold;"><?php echo $_SESSION['product']; ?></span>  Country: <span style="color: #2E8DCC;font-weight: bold;"><?php echo $_SESSION['country']; ?></span> </h3>
                   ...
                   <center>
                    <iframe src="<?php echo $_SESSION['file1'] ?>" height="600px" width="900px">
                      <p>dsf</p>
                    </iframe>
                     <div style="font-size: 25px;"> <span style="color: #2E8DCC;font-weight: bold">---------   </span> Actual Revenue </div>
                     <div style="font-size: 25px;"> <span style="color: orange;font-weight: bold">-----  </span>Predicted  Revenue</div>
